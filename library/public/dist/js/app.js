...
define("app", [ "./pages/add", "./components/typeConfig", "./pages/login", "./pages/index", "./pages/list", "./components/utils", "./pages/search", "./pages/me" ], function(require, exports, module) {
    var add = require("./pages/add"), login = require("./pages/login"), index = require("./pages/index"), list = require("./pages/list"), search = require("./pages/search"), me = require("./pages/me"), app = {};
    app.init = function() {
