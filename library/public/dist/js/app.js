...
define("app", [ "./pages/add", "./components/typeConfig", "./pages/login", "./pages/index", "./pages/list", "./components/utils" ], function(require, exports, module) {
    var add = require("./pages/add"), login = require("./pages/login"), index = require("./pages/index"), list = require("./pages/list"), app = {};
    app.init = function() {
