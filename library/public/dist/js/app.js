...
define("app", [ "./pages/add", "./components/typeConfig", "./pages/login", "./pages/index", "./pages/list", "./components/utils", "./pages/search", "./pages/me", "./pages/removeBook", "./pages/detail" ], function(require, exports, module) {
    var add = require("./pages/add"), login = require("./pages/login"), index = require("./pages/index"), list = require("./pages/list"), search = require("./pages/search"), me = require("./pages/me"), removeBook = require("./pages/removeBook"), detail = require("./pages/detail"), app = {};
    app.init = function() {
