...
define("app", [ "./pages/add", "./components/typeConfig", "./pages/login", "./pages/index" ], function(require, exports, module) {
    var add = require("./pages/add"), login = require("./pages/login"), index = require("./pages/index"), app = {};
    app.init = function() {
