...
define("app", [ "./pages/add", "./components/typeConfig", "./pages/login", "./pages/index", "./pages/list", "./components/utils", "./pages/search" ], function(require, exports, module) {
    var add = require("./pages/add"), login = require("./pages/login"), index = require("./pages/index"), list = require("./pages/list"), search = require("./pages/search"), app = {};
    app.init = function() {
...
define("pages/add", [ "../components/typeConfig" ], function(require, exports, module) {
    ...
    page.changeSubType = function() {
        $type.change(function() {
            $subType.empty();
            var val = $(this).children("option:selected").val(), subTypeList = typeConfig[val], subTypeListHtml;
...
define("pages/index", [ "../components/typeConfig" ], function(require, exports, module) {
    ...
    page.createSubType = function() {
        $menu.children("li").mouseover(function() {
            var $this = $(this), subListHtml, type = $this.attr("data-val"), flag = $this.attr("data-subMenu");
            if (Number(flag) === 0) {
...
define("pages/list", [ "../components/utils" ], function(require, exports, module) {
    var utils = require("../components/utils"), sort = utils.getUrlParam("sort"), page = {};
    //初始化filter排序选项的样式
...
define("pages/search", [], function(require, exports, module) {
    var page = {};
    //选择框的样式
