...
define("app", [ "./pages/add", "./components/typeConfig", "./pages/login", "./pages/index", "./pages/list", "./components/utils", "./pages/search", "./pages/me", "./pages/removeBook", "./pages/detail", "./pages/admin" ], function(require, exports, module) {
    var add = require("./pages/add"), login = require("./pages/login"), index = require("./pages/index"), list = require("./pages/list"), search = require("./pages/search"), me = require("./pages/me"), removeBook = require("./pages/removeBook"), detail = require("./pages/detail"), admin = require("./pages/admin"), app = {};
    app.init = function() {
...
define("pages/admin", [ "../components/utils" ], function(require, exports, module) {
...
define("pages/detail", [], function(require, exports, module) {
    var page = {};
    page.init = function() {
        //图书介绍和评价的切换
        $(".toggleTitle .title").click(function() {
            var $this = $(this), $target = $("." + $this.attr("data-target")), $hide = $("." + $this.attr("data-hide"));
            $target.show();
            $hide.hide();
