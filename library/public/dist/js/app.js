...
define("components/typeConfig", [], function(require, exports, module) {
    var typeConfig = {
        typeList: [ "文学", "少儿", "管理", "励志与成功", "人文社科", "生活", "艺术", "科技", "计算机与互联网", "教育" ],
        ...
        "科技": [ "科普图鉴", "地球科学", "数理化", "天文航天", "生物世界", "神秘现象", "百科知识", "通信", "基本电子电路", "微电子学、集成电路(IC)", "移动通信", "电子元件、组件", "无线电设备、电信设备", "半导体技术", "光电子技术、激光技术", "电工电气", "机械、仪表工业", "自动化技术", "汽车与车辆", "交通运输", "能源与动力工程", "水利水电", "科技参考工具书", "中国医学", "基础医学", "临床医学", "护理学", "内科学", "外科学", "肿瘤学", "药学", "园林景观", "城乡建设、市政工程、环境工程", "城市规划、城市设计", "室内设计、装饰装修", "建筑工具书", "建筑标准和规范", "建筑法律法规", "畜牧、狩猎、蚕、蜂", "水产、渔业" ],
